...
namespace Bitwiseph\InstagramMedia\Http\Services;
...
class InstagramService
{
    ...
    function __construct(  ) {
        $accessToken = config('bitwiseph.instagram.access_token');
        $params = array(
            'get_code' => isset( $_GET['code'] ) ? $_GET['code'] : '',
            'access_token' => $accessToken,
            'user_id' => config('bitwiseph.instagram.user_id')
        );

        $this->_appId=config('bitwiseph.instagram.app_id');
        $this->_appSecret=config('bitwiseph.instagram.app_secret');
        $this->_redirectUrl=config('bitwiseph.instagram.app_redirect');
